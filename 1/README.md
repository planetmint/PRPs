...
1. All contributors contributing a patch MUST do and understand the steps listed in [PRP-24](../24).
...
Definition: **Public Contracts** _noun_ - All public APIs and protocols. In other words, read the PRPs (and the things they reference) and you'll have a good start.
...
1. Administrators SHOULD remove Maintainers who are inactive for an extended period of time, or who repeatedly fail to apply this process accurately.BCP
...
This PRP is free software; you can redistribute it and/or modify it under the terms of the GNU AFFERO GENERAL PUBLIC LICENSE as published by the Free Software Foundation; either version 3 of the License, or (at your option) any later version.
